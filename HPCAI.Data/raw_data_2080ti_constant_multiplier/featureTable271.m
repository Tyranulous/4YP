function [tableOut] = featureTable271(data)
telescopes = length(data);

features_matrix = nan(telescopes,14);
nan_time1 = nan(telescopes,1);
nan_time2 = nan_time1;
nan_time4 = nan_time1;
for t = 1:telescopes
...
%     locs = start_pos:end_pos;
    ...
    features_matrix(t,16) = norm_telescope_tps(271);
...
tableOut = array2table(features_matrix,'VariableNames',{'unrolls','numreg','divint','divindm','cf','tsamp','nchans','bw','max_dm_step','min_dm_step','max_dm','ndm_ranges','num_dm_samples','mean_dm_binning','mean_dm_step','time_per_sample'});
